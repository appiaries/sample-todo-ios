...
#import <AppiariesSDK/APISConstants.h>
 ...
 * @warning 本クラスを使用するには、別途 Facebook SDK および AppiariesFacebookKit.framework をプロジェクトに組み込む必要があります。
 * @since AppiariesFacebookKit 1.3.1
 */
 ...
 * @brief Facebookアカウントを使用してアプリにログインします。会員が作成されていない場合は新規作成されます。
